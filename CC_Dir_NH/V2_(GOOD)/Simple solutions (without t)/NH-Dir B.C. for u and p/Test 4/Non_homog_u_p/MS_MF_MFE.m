...
% sigma2=build_exact_sol_sigma(t);
...
% sigma=zeros(48,1);
% sigma([2,3,6,7,10,11,14],1)=(lambda+mu);
% sigma([15,18,19,21,24,25,28,29,31,34],1)=(lambda+mu)-alpha/4;
% sigma([35,38,39,42,44,45,48],1)=(lambda+mu)-alpha/2;
gTp=Asp*sigma + App*p;
% gTp=zeros(N*N,1);
