...
% Indep. terms for non-homogeneous Dir. B.C. at t0=0.
[gDu0,gDp0]=dir_bc_Pg0(delta_t,t);   
f0_hat= f0_indep + gDu0; 
q0_hat= q0_indep + gDp0;

% Matrix A22 of flux stationary problem at t0=0.
A22_t0=build_flux_matrix_t0;
...
% Now we compute the rest of the elasticity variables at t0=0:
        % rotation 
gamma=compute_gamma_t0(u,t);  
        % stress
[sigma,~,~,~,~]=compute_tensors_t0(u,gamma,t);
