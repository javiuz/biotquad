...
f0_indep=f_hat-A12*p0;
u0=A11\f0_indep;

% Now we compute the rest of the elasticity variables at t0=0:
        % rotation 
gamma0=compute_gamma(u0,p0,t);  
        % stress
[sigma0,~,~,~,~]=compute_tensors(u0,p0,gamma0,t);

% Now we solve the QUASI-STATIC SYSTEM at t=0:

% Initial time terms affecting q
gTp=Asp*sigma0 + App*p0;
...
% Now we compute again the rest of the elasticity variables:
        % rotation 
