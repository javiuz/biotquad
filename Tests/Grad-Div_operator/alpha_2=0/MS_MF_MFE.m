...
[A11,A12,A22,App]=build_matrices_Biot(delta_t);
% A21=-A12';
A21=zeros(N*N,2*N*N);
% Asp=AspT';

% Matriz del sistema reducido de Biot (original)
% Biot_matrix=[A11 A12;A21 A22];

% Matriz del sistema Biot con alpha_{2}=0
% Biot_matrix=[A11 A12;0 A22];
Biot_matrix=[A11 A12;A21 A22];

% Matriz del sistema de Biot con alpha_{1}=0
% Biot_matrix=[A11 0;A21 A22];
